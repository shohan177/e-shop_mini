      ...
      <div class="container">
        <div class="shop-menu ml-0 mr-0">
          <div class="row">
            ...
            <div class="col-sm-4">
              <form  action="" method="POST"class="inline-form"> 
                <div class="input-group">
                <select name="mx_value" class="form-control">
                  <option selected="selected" value="">Select Price Ranage</option>
                  <option      value="0:100">0________100</option>
                  <option    value="100:500">100______500</option>
                  <option   value="500:1000">500______1,000</option>
                  <option  value="1000:1500">1,000____1,500</option>
                  <option  value="2000:3000">2,000____3,000</option>
                  <option  value="3000:4000">3,000____4,000</option>
                  <option  value="4000:10000">4,000___10,000</option>
                  <option value="10000:20000">10,000__20,000</option>
                </select>  
               <span class="input-group-btn"><button type="submit" name="mx_btn" class="btn btn-color">Search</button></span>
              </div>
              </form>   
          ...
          <div class="col-sm-4">
            <form  action="" method="POST"class="inline-form">
                      <div class="input-group">
                        <input type="txt" name="ss" placeholder="Name/Brand/Model/Chatagory" class="form-control">
                        <span class="input-group-btn"><button type="submit" name="ss_btn" class="btn btn-color">Search</button></span>
                      </div>
              </form>
        </div>
          ...
          if (isset($_POST['ss_btn']))
          {
              ...
              if(empty($serach)){
                $sql = 'SELECT * FROM product';
                 ...
                 $sql =  "SELECT * FROM product WHERE chatagory ='$serach' OR name = '$serach' OR brand = '$serach'OR model ='$serach'";
                }

          }
          elseif (isset($_POST['mx_btn']))
          {
             $mx = $_POST['mx_value'];
             if (empty($mx)) {
               $sql = 'SELECT * FROM product';
             }else{
              list($min, $max) = explode(":",$mx); 
              $sql ="SELECT * FROM product WHERE special_price BETWEEN $min AND $max";
             }
          ...
          <div class="col-md-3 col-sm-6">
            <div class="shop-product">
              <div class="product-thumb">
                <a href="shop-single.php?id=<?php echo $fdata['id'];echo ":";echo $fdata['chatagory'];?>">
                  <img class="img" src="photos/<?php echo $fdata['img']; ?>" alt="">
                </a>
                <div class="product-overlay">
                  <a href="shop-single.php?id=<?php echo $fdata['id'];echo ":";echo $fdata['chatagory'];?>" class="btn btn-color-out btn-sm">View Product<i class="ti-bag"></i></a>
                </div>
              </div>
...
<!-- Mirrored from themes.hody.co/html/comet/shop-4col.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Jan 2017 09:51:25 GMT -->
</html>