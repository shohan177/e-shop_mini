          ...
          <ul class="navigation-menu">
            ...
            <li class="has-submenu">
              ...
              <!-- <ul class="submenu">
                ...
                <li>
                  <a href="shop-single.html">Admin</a>
                </li>
                <li>
    ...
    <section>
      <div class="container">
          ...
          <div class="row">
            <div class="col-md-6">
              <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
                <ul class="slides">
                  <li>
                    <img src="photos/<?php echo $fdata['img']; ?>" alt="">
                  </li>
                  <!-- <li>
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2><?php echo $fdata['name']; ?><span class="red-dot"></span></h2>
              ...
              <div class="single-product-list">
                <ul>
                  <li><span>Brand: </span><?php echo $fdata['brand'] ?></li>
                  <li><span>Model: </span><?php echo $fdata['model'] ?></li>
                  
                  <li><span>Category: </span><a href="#"><?php echo $fdata['chatagory'] ?></a>
                  </li>
        ...
        <div class="product-tabs">
          ...
          <div class="tab-content">
            <div id="first-tab" role="tabpanel" class="tab-pane active">
              <p><?php echo $fdata['discripation'] ?></p>
            </div>
        ...
        <div class="related-products">
          ...
          <div class="row">
          <?php 
            //recive related product
            
             $sql = "SELECT * FROM product WHERE chatagory ='$cta' LIMIT 4";
             $data = $connection -> query($sql);
            ...
            <div class="col-md-3 col-sm-6">
              <div class="shop-product">
                ...
                <div class="product-info">
                  <h4 class="upper"><a href="shop-single.php?id=<?php echo $fdata['id'];echo ":";echo $fdata['chatagory'];?>"><?php echo $fdata['name'] ?></a></h4><span><del><?php echo $fdata['regular_price'] ?> TK</del></span><br>
                <span><?php echo $fdata['special_price'] ?> TK</span></span>
